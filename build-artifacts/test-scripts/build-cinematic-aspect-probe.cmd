...
cl /nologo /LD /std:c++latest /O1 /MT /EHsc /utf-8 /DNDEBUG /DCUTSCENE_TRANSITION_TRACE /DCINEMATIC_ASPECT_PROBE /I..\..\external\safetyhook /I..\..\external\spdlog\include ..\..\src\cutscene_letterbox_fix.cpp ..\..\external\safetyhook\safetyhook.cpp ..\..\external\safetyhook\Zydis.c /link user32.lib /OUT:"%~dp0..\test-asi\STALKER2ExperimentalCinematicAspectProbe.asi"
if errorlevel 1 goto :fail

echo Build succeeded: %~dp0..\test-asi\STALKER2ExperimentalCinematicAspectProbe.asi
pause
popd
exit /b 0
...
:fail
echo ERROR: Cinematic aspect probe build failed.
pause
popd
exit /b 1
